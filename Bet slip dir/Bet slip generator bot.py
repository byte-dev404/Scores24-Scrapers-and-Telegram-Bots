...
# To return built bot instead of running it
def build_app():
    ...
    application.add_handler(CommandHandler("generate_bet_slip", generate_bet_slip_command))
    application.add_handler(CallbackQueryHandler(handle_sport_selection, pattern="^(sport:|sport_next)"))
    application.add_handler(CallbackQueryHandler(handle_time_range_selection, pattern="^(time_range:|time_next)"))
    application.add_handler(CallbackQueryHandler(handle_market_selection, pattern="^(market:|market_next)"))
